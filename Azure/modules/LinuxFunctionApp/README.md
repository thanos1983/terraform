...
```bash
module "linux_function_app_<project>" {
  source = "git::https://example.com/linux_function_app_<my_repo>.git"
...
###### More information can be found on the official document [linux_function_app](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/linux_function_app)
