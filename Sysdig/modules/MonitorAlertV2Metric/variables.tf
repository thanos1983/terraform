...
variable "duration_seconds" {
  description = "A time interval that defines for how long a condition should be met before an alert occurrence is created."
  type        = number
  default     = null
}
...
variable "operator" {
  description = "Condition operator of the event count."
  type        = string
}
...
variable "no_data_behaviour" {
  description = "Behaviour in case of missing data."
  type        = string
  default     = null
}
